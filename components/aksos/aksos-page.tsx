...
export function AksosPage() {
  return <main id="top" className="aksos-shell">
    ...
    <section className="atis-section" id="intelligence"><div className="section-copy"><SectionLabel index="07">ATIS / Africa Trade Intelligence System</SectionLabel><h2>Information becomes<br /><em>perspective.</em></h2><p>ATIS is a multi-layer intelligence system for reading the relationships behind the signal.</p></div><div className="atis-visual"><div className="atis-layers"><span>INFORMATION</span><b>↓</b><div className="layer-box"><small>DATA COVERAGE</small><Network preset="intelligence" label="ATIS intelligence layers" /><small>ECOSYSTEM / RELATIONSHIPS</small></div><b>↓</b><span>CONTEXT</span><b>↓</b><span>PERSPECTIVE</span><b>↓</b><strong>INTELLIGENCE</strong></div><PerspectiveDiagram /></div></section>

    <section className="use-cases"><SectionLabel index="08">Question-specific intelligence</SectionLabel><h2>Different questions.<br /><em>Different meaning.</em></h2><div className="case-grid"><article><span>01 / INVESTOR</span><h3>Find the opportunity inside the ecosystem.</h3><div className="case-landscape"><i>QUESTION</i><b>↓</b><i>ECOSYSTEM</i><b>↓</b><i>KEY ACTORS</i><b>↓</b><i>CAPITAL</i><b>↓</b><strong>OPPORTUNITY</strong></div></article><article><span>02 / ENTERPRISE</span><h3>See what surrounds the company.</h3><div className="case-expansion"><b>SUPPLIER</b><i>—</i><strong>ENTERPRISE</strong><i>—</i><b>INSTITUTION</b><b>PROJECT</b><b>OPPORTUNITY</b></div></article><article><span>03 / OPERATOR</span><h3>Understand what an event means for you.</h3><div className="case-perspective"><strong>EVENT</strong><i>↓</i><b>MY CONTEXT</b><i>↓</i><span>MARKET　 POLICY　 PEOPLE</span><i>↓</i><strong>WHAT IT MEANS</strong></div></article></div></section>

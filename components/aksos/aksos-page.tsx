...
function Nav() {
  return <header className="aksos-nav"><a href="#top" className="wordmark" aria-label="AKSOS home">AKSOS<span className="wordmark-dot">.</span></a><nav aria-label="Primary navigation"><a href="#how-it-works">How it works</a><a href="#contact">Contact</a></nav><span className="nav-status"><span className="status-dot" /> Intelligence infrastructure</span></header>
}
